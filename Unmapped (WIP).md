...
(1)**labyrint where you have to explore a undiscovered map.** 

(2)**Make a creature** that haunts you, but **has some kind of disability**.
...
make a (3)**flashlight mechanism**, where you have to (4)**pick up batteries**, which will be (5)**located** **randomly placed on the map**.

in the top *left corner, make a bar that shows* (6)***how much percent of your battery is remaining***
...
Jednoho dne Ioannes seděl doma a věnoval se svým obvyklým, nudným činnostem svého obyčejného života. Pracoval jako účetní pro řetězec supermarketů a jak se dalo čekat – mít vysokoškolský diplom a skončit v supermarketu mu dělalo život mnohem, mnohem smutnějším, než si kdy představoval.
